...
//
//trait LongsImpl extends BiTypeImpl[Long] {
//  final val typeID = 3
//
...
//
//  protected def readTuple1[S <: Sys[S]](opID: Int, in: DataInput, access: S#Acc, targets: Targets[S]): ExN[S]
//
//  protected final def readLongOp1[S <: Sys[S]](opID: Int, in: DataInput, access: S#Acc,
//                                               targets: Targets[S]): ExN[S] = {
//    import UnaryOp._
//    val op = (opID: @switch) match {
//      case Neg    .id => Neg
...
//  }
//
//  protected final def readSpanOp1[S <: Sys[S]](opID: Int, in: DataInput, access: S#Acc,
//                                               targets: Targets[S]): ExN[S] = {
//    import UnaryOp._
//    val op = (opID: @switch) match {
...
//        val opID = in.readInt()
//        readTuple1(opID, in, access, targets)
//
//        import UnaryOp._
