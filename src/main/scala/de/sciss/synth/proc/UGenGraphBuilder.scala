...
//   sealed trait BuildResult // [ S <: evt.Sys[ S ]]
////   case object Halted extends BuildResult
////   case object Advanced extends BuildResult
//
////   final case class Finished[ S <: evt.Sys[ S ]]( graph: UGenGraph /*, scanIns: Set[ String ], scanOuts: Map[ String, Int ]*/)
////   extends BuildResult[ S ]
//
//   final case class Finished( graph: UGenGraph /*, scanIns: Set[ String ], scanOuts: Map[ String, Int ]*/)
//   extends BuildResult
//
//   final case class Partial[ S <: evt.Sys[ S ]]( missingScanIns: Set[ MissingIn[ S ]], advanced: Boolean )
//   extends BuildResult[ S ]
