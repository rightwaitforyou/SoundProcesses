...
import de.sciss.lucre.expr.{Chronos, BiExpr, Expr}
...
//      protected def playing_# : Expr.Var[ S, Boolean ]
      protected def playing_# : BiExpr.Var[ S, Boolean ]
      protected def name_# : Expr.Var[ S, String ]
//      protected def freq_# : Expr.Var[ S, Double ]
      protected def freq_# : BiExpr.Var[ S, Double ]
...
//         }
   ...
   private final class New[ S <: Sys[ S ]]( tx0: S#Tx ) extends Impl[ S ] {
      ...
      protected val playing_# = BiExpr.newConfluentVar[ S, Boolean ]( true )( tx0, Booleans ) // Booleans.newVar[ S ]( true )( tx0 )
//      protected val freqVar   = {
//         implicit val peerSer = Doubles.serializer[ S ]
//         tx0.newVar[ Expr[ S, Double ]]( id, 441 )
//      }
      protected val freq_#    = BiExpr.newConfluentVar[ S, Double ]( 441 )( tx0, Doubles ) // Doubles.newConfluentVar[ S ]( 441 )( tx0 )
...
//      protected val freq_#    = Doubles.readVar[ S ]( in, access )( tx0 )
      protected val playing_# = BiExpr.readVar[ S, Boolean ]( in, access )( tx0, Booleans )
      protected val freq_#    = BiExpr.readVar[ S, Double  ]( in, access )( tx0, Doubles  )
