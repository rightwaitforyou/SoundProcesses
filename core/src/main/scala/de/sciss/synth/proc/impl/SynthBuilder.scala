...
//  * @see  [[AuralProcImpl]]
//  */
//final class SynthBuilder1(timeRef: TimeRef, wallClock: Long, synth: Synth)
...
//
//    val node = ??? : AuralNode // AuralNode(timeRef, wallClock, synth, users = users, resources = dependencies)
//
